...
import InteractiveSystem from './components/sections/InteractiveSystem';
import ResidentialExperience from './components/sections/ResidentialExperience';
import CommercialIndustrial from './components/sections/CommercialIndustrial';
import RoiCalculator from './components/sections/RoiCalculator';
import InstallationProcess from './components/sections/InstallationProcess';
import Projects from './components/sections/Projects';
import Technology from './components/sections/Technology';
import BatteryStorage from './components/sections/BatteryStorage';
...
function Navbar() {
  ...
  useEffect(() => {
    // Solid glass background once the hero is fully behind you — before
    // that point, the navbar's own background is driven continuously by
    // --p (set in the Hero effect below, on <html>).
    function onScroll() {
      const hero = document.getElementById('hero');
      const pastHero = hero ? hero.getBoundingClientRect().bottom <= 0 : window.scrollY > 400;
